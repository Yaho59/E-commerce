...
function ProductDetail() {
  ...
  return (
    <aside className={`${isProductDetailOpen ? 'flex' : 'hidden'} w-full h-h-calc  flex-col fixed right-0 top-[48px] border border-black rounded-lg bg-white z-10 sm:w-[360px]`}>
